...
st.markdown("The objectif of this section is to see if the models misclassify for the same individuals. The test will be done on $X_i$  We will show the graphes of the folowing fonctions: ")
